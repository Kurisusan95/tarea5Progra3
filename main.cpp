...
int main( int argc, char* args[] )
{
    ...
    while(true)
    {
        ...
        vector<Hurtbox*>char1_hurtboxes=character->getHurtboxes();
        vector<Hurtbox*>char2_hurtboxes=character2->getHurtboxes();
        ...
        for(int i=0;i<char2_hitboxes.size();i++)
        {
            for(int j=0;j<char1_hurtboxes.size();j++)
            {
                SDL_Rect rect1 = char2_hitboxes[i]->rect;
                SDL_Rect rect2 = char1_hurtboxes[j]->rect;
